...
function mostrarAlumnos(){    
    ...
    for (const [n, e] of alumnos) {
          ...
          document.getElementById("info").innerHTML=`el alumno : ${n} tiene : ${e} anios`;
    }
}
...
function mostrarMediaEdad(){
    ...
    document.getElementById("info").innerHTML=`La edad media es : ${edadMedia}`;
...
/**
 tipo barco[set]=["lanchas","portaviones","fragatas"];
 tipo.Map=tamaño={lanchas=2,pota=6,fragatas=4};
